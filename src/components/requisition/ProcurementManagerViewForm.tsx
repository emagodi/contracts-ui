...
export default function ProcurementManagerViewForm({ requisition, onSubmit, submitting, error, onCancel }: {
  requisition: Requisition;
  onSubmit: (decision: "YES" | "NO") => void;
  submitting?: boolean;
  error?: string | null;
  onCancel: () => void;
}) {
  ...
  return (
    <div className="max-w-5xl mx-auto mt-8 bg-white border-2 border-black shadow-lg rounded-sm p-10 text-gray-900">
        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-2 gap-6 text-sm text-black mt-6">
            <div className="flex items-center gap-3 text-black">
              ...
              <label className="flex items-center gap-1 ml-2"><input type="radio" name="pmDecision" value="YES" checked={decision === "YES"} onChange={() => setDecision("YES")} /> Yes</label>
      ...
      <div className="mt-8 flex justify-end gap-3">
        ...
        <Button size="sm" className="rounded-full bg-sky-600 hover:bg-sky-700 text-white" disabled={submitting || !decision} onClick={() => onSubmit(decision as "YES" | "NO")}>
