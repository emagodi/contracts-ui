...
export default function CompanySecretaryViewForm({ requisition, onSubmit, submitting, error, onCancel }: {
  ...
  return (
    <div className="max-w-5xl mx-auto mt-8 bg-white border-2 border-black shadow-lg rounded-sm p-10 text-gray-900">
      ...
      <div className="border border-black mt-8">
        <div className="border-b border-black bg-blue-200 p-3">
          <h2 className="text-md font-semibold text-black">10. Administrative Issues</h2>
        </div>
        <div className="p-4">
          <div className="flex justify-between items-center border-b border-black p-3">
            <div className="flex items-center gap-3 text-black opacity-70">
              Funding for the contract price is available:
              <label className="flex items-center gap-2 ml-2">
                <input type="radio" value="YES" disabled checked={val("fundingAvailable") === "YES"} />
                <span className="text-emerald-700 flex items-center gap-1"><CheckLineIcon /> Yes</span>
              </label>
              <label className="flex items-center gap-2">
                <input type="radio" value="NO" disabled checked={val("fundingAvailable") === "NO"} />
          ...
          <div className="flex justify-between items-center p-3 border-b border-black opacity-70">
            <div className="flex items-center gap-3 text-black">
              ...
              <label className="flex items-center gap-1 ml-2"><input type="radio" value="YES" disabled checked={val("procurementComplied") === "YES"} /> Yes</label>
            ...
            <div className="flex items-center gap-2">
              {procPreviewUrl ? (
                ...
                <Input readOnly name="procurementManager" defaultValue={val("procurementManager")} placeholder="------------------------------------------------------------------------------------------------------------------------------------------------------" className={readOnly + " w-3/4"} />
              )}
              <Input readOnly name="procurementDate" defaultValue={formatDisplayDate(val("procurementDate"))} placeholder="------------------------------------------------------------------------------------------------------------------------------------------------------" className={readOnly + " w-3/4"} />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-3 gap-6 mt-2 text-sm text-black">
            <div>
              {secPreviewUrl ? (
                ...
                <Button size="sm" className="w-[200px] h-12 bg-emerald-600 hover:bg-emerald-700 text-white rounded-md" onClick={signSecretary}>Sign</Button>
              )}
